...
from ims.service.clientWorkServ import getClientWork, getClientWorkList, getClientWorkDetails
...
# 稼働詳細画面処理
@clientWork.route('/details/<int:month>/<int:day>/<int:clientWorkId>')
@login_required
