...
masterDataManagement = Blueprint('masterDataManagement', __name__)


@masterDataManagement.route('/list/')
@login_required
def master_list():
...
@masterDataManagement.route('/details/<string:userId>/edit')
@login_required
...
@masterDataManagement.route('/register', methods=['GET', 'POST'])
@login_required
def register():
    form = UserForm()
