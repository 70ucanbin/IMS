...
class TraMonthlyReport(db.Model):
    ...
    def __init__(self, user_id=None, work_year=None, work_month=None, \
    ...
    def __repr__(self):
        return '<TraMonthlyReport user_id:{} work_year:{} work_month:{} work_day:{}>'.format(self.user_id, self.work_year, self.work_month, self.work_day)